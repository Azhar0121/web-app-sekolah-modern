    ...
    <form method="POST"
            ...
            <div class="form-grid">
                ...
                <div class="form-field full">
                    ...
                    <input
                        ...
                        name="full_name"
                        value="{{ old('full_name') }}"
                        placeholder="Sesuai akta lahir / ijazah"
                        required
                    >
                </div>
        ...
        <div class="form-card">
            ...
            <div class="form-grid">
                ...
                <div class="form-field">
                    <label>
                        No. HP Orang Tua/Wali <span>*</span>
                    </label>
        ...
        <div class="form-card">
            ...
            <div class="form-grid">
                ...
                <div class="form-field full">
                    <label>
                        Nama Sekolah Asal (SMP) <span>*</span>
                    </label>
                    ...
                    <input
                        ...
                        placeholder="Nama SMP/sederajat"
                        required
                    >
                </div>
                ...
                <div class="form-field">
                    <label>
                        Nilai Rata-rata Rapor <span>*</span>
                    </label>
        ...
        <div class="form-card">
            ...
            <div class="document-info">
                ...
                <strong>
                    Dokumen bersifat opsional saat ini
                </strong>

                <p>
                    Format PDF/JPG/PNG, maksimal 2MB per file.
                    Dokumen yang belum lengkap bisa disusulkan langsung
                    ke sekolah.
                </p>
