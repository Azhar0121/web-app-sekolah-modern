    ...
    <form method="POST" action="{{ route('ppdb.store') }}" enctype="multipart/form-data">
        ...
        <fieldset style="margin-bottom: 16px;">
            ...
            <p>
                ...
                <small style="color: #888;">Catat tanggal lahir ini — dipakai juga untuk memulihkan nomor pendaftaran kalau lupa.</small>
            </p>
            <p>
            ...
            <p>
                ...
                <small style="color: #888;">Nomor pendaftaran akan dikirim ke email ini — pastikan aktif dan benar.</small>
            </p>
        </fieldset>
