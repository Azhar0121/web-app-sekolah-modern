        ...
        <div class="teaching-create-header">
            <div class="teaching-create-header-content">
                ...
                <div class="teaching-create-title">
                    ...
                    <div>
                        <span class="teaching-create-label">PENUGASAN MENGAJAR</span>
                        <h1>Tambah Penugasan</h1>
                        <p>Tambahkan guru untuk mengampu mata pelajaran pada kelas tertentu.</p>
                    </div>
                </div>
        ...
        <div class="teaching-create-card">
            ...
            <div class="teaching-create-card-header">
                ...
                <div>
                    ...
                    <p>Lengkapi informasi penugasan mengajar di bawah ini.</p>
                </div>
